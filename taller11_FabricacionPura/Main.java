package taller11_FabricacionPura;
...
public class Main {
    public static void main(String[] args) {
        ...
        Cliente cliente = fabrica.crearCliente("Alejo", "Cr 26a #42-40");
        Pedido pedido = fabrica.crearPedido(1, new Date(), cliente);
        Producto producto1 = fabrica.crearProducto("Celular", 100.0, 100);
        Producto producto2 = fabrica.crearProducto("USB", 20.0, 100);
